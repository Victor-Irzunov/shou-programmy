...
export const metadata = {
	title: 'Новогодняя шоу программа | Артисты на новогодний корпоратив',
	description: '',
	alternates: {
		canonical: ''
	}
		...
		<main className='sd:pt-36 xz:pt-24 pb-10 overflow-x-hidden'>
			<div className='container mx-auto'>
				...
				<div className="w-full mt-10 mx-auto">
					<Image src='/uslugi/2.webp' className="mx-auto" alt="Новогодняя шоу программа " width={645} height={608} />
				</div>
