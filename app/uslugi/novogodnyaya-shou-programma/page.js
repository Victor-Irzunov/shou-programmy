	...
	return (
		<main className='sd:pt-24 xz:pt-24 pb-10 overflow-x-hidden'>
			<div className='container mx-auto'>
				...
				<article className='mt-16 text-center'>
					...
					<ul className='mt-4'>
						...
						<li className='mb-5'>
							...
							<p className='text-gray-800'>
								Эта уникальная программа обещает незабываемый вечер для вас и ваших гостей на Новогоднем корпоративе, наполненный страстью, магией и радостью. Этот вечер будет незабываемым, и вы будете вспоминать его с восторгом.
							</p>
						</li>
					</ul>
				...
				<Image src='/svechi.webp' className="mx-auto" alt='Свечи в стиле Новогоднего корпоратива' width={200} height={200} />
			</div>
		</main>
	)
}
