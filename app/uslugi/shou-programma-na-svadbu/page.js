			...
			<div className='container mx-auto'>
				...
				<section className="">
					...
					<div className="w-full mt-10 mx-auto">
						<Image src='/uslugi/shou-programma-na-svadbu/main1.webp' className="mx-auto" alt="Шоу программа на свадьбу" width={645} height={608} />
					</div>
					...
					<div className='text-center mt-16'>
						<a href="tel:80445992515">
							<button
								className='bg-[#c9a035] shadow-lg px-12 py-2 text-white uppercase hover:transform hover:scale-110 transition-transform'
							>
								Позвонить
							</button>
						</a>
				...
				<article className='mt-16 text-center'>
					...
					<div className='sd:mt-20 xz:mt-12 text-justify sd:px-4 xz:px-0 sd:py-6 sd:shadow-md xz:shadow-none'>
						<h6 className='font-semibold text-lg mb-3 text-center'>
							Как и чем удивить гостей на свадьбе? Артисты на свадьбу.
						</h6>
						<p className='mb-4'>
							Хотите сделать свадьбу незабываемой, чтобы гости говорили: 'Я хочу такую же!'? Придется немного постараться! Никому не секрет, что одной из задач свадьбы является показ того, как молодожены, их родители и гости относятся к этому событию. Свадьба должна превратиться в настоящий праздник и торжество!
						</p>
						<p className='mb-4'>
							Всем известно, что атмосфера праздника - это эмоции и сопровождающие их действия: поздравления молодых, веселые конкурсы, громкие аплодисменты и, конечно же, выступления приглашенных артистов и шоу. Все хотят выбрать лучшее шоу из предложенных, но, к сожалению, это не всегда удается. Ведь каждый артист, ведущий или ансамбль уверенным голосом обещает, что все будет на высшем уровне. Однако слова - не дело!
						</p>
						<p className='mb-4'>
							Для обыкновенного зрителя не всегда ясно, что хорошее шоу - это результат огромного труда: постановка номеров, долгие и упорные репетиции, отработка актерских навыков, взаимодействие с аудиторией, запись фонограмм и многое другое. Проверить это не всегда возможно, и многим не хочется тратить на это время.
						</p>
						<p className='mb-4'>
							Так чем же руководствоваться при выборе? Самым важным фактором становится промо-видео коллектива (артиста), хотя мы не всегда используем этот метод должным образом. Забываем, что это может быть единственным и одним из наиболее важных моментов при выборе шоу или артистов на вашу свадьбу или праздник.
						</p>
						<p className='mb-4'>
							Видео, которое вам предоставляют агентства или которое вы находите в сети, несет в себе множество информации. Например, оно позволяет оценить композицию номеров, мастерство ведущего или актера, харизму, техническую базу танцоров и вокалистов, их профессиональную подготовку, репертуар и, конечно, костюмы. Ведь одежда играет важную роль!
						</p>
						<p className='mb-5'>
							Самая частая и неверная ошибка в процессе выбора - невнимательность. Многие начинают просматривать промо-ролик и сразу же делают выбор в пользу коллектива, аргументируя это тем, что им понравились костюмы или услышали знакомую песню. Важно не только смотреть внимательно, но и смотреть много! Попробуйте посмотреть разные коллективы и артистов, чтобы сформировать более объективное мнение. Обратите внимание на детали, так как внимательный взгляд может уловить много интересного.
						</p>
						<p className=''>
							Тратя время на тщательный отбор, вы создадите программу, которая порадует вас и ваших гостей на вашем празднике.
						</p>
					</div>
