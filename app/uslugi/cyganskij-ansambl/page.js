		...
		<main className='sd:pt-36 xz:pt-24 pb-10'>
			<section className="container mx-auto sd:px-24 xz:px-0">
				...
				<div className="w-full mt-10 mx-auto">
					<Image src='/uslugi/cyganskij-ansambl/main.webp' className="mx-auto" alt="искусство шоу Бетельгейз" width={645} height={608} />
				</div>
				<div className='text-center uppercase mb-8 mt-10 text-[#c9a035] font-light text-2xl'>
					...
					<Image src='/uslugi/cyganskij-ansambl/logoGold.svg' className="mx-auto" alt='Живой голос' width={55} height={55} />
					<p className="mx-2 mt-2 mb-6">
						Профессиональные артисты
					</p>
					<Image src='/uslugi/cyganskij-ansambl/scene.svg' className="mx-auto" alt='Живой голос' width={50} height={50} />
